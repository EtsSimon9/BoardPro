...
public class ControleurPopSrc {
    ...
    public ControleurPopSrc() {
		
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("/vue/PopSrcOverview.fxml"));
    ...
    public void initialize() {
    	PopSrcVol.setPromptText("Default number");
    	PopSrcAmp.setOnKeyTyped(tfNumOnly());
	}
